...
export class Product implements Prototype<Product> {
  ...
  public objectProperty: unknown | null = null;
  ...
  public clone(): Product {
    ...
    clone.primitiveProperty = this.primitiveProperty;
    clone.objectProperty = this.objectProperty;
    clone.arrayProperty = this.arrayProperty;
    return clone;
  }
}
